...
export default function InfiniteMenu({ items = defaultItems }) {
  ...
  return (
    <div className="relative w-full h-full">
      ...
      {/* Blur Text "Drag to Know More" - Always visible */}
      <div
        className={`
          absolute
          left-1/2
          ...
          duration-1000
          ease-out
          ${isMoving ? 'opacity-0 scale-95' : 'opacity-60 scale-100'}
        `}
      >
        <div className="relative">
          {/* Multiple blur layers for text effect */}
          <span className="absolute inset-0 text-white text-lg font-medium blur-sm opacity-70">
            Drag to Know More
          </span>
          <span className="absolute inset-0 text-white text-lg font-medium blur-md opacity-50">
            Drag to Know More
          </span>
          <span className="absolute inset-0 text-white text-lg font-medium blur-lg opacity-30">
            Drag to Know More
          </span>
      ...
      {activeItem && (
        ...
        `}
          ...
          ${isMoving
                ...
                : 'opacity-100 pointer-events-auto duration-[500ms] translate-x-[-100%] -translate-y-1/2'
              }
        `}
          >
