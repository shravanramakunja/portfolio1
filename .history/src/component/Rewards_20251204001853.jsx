...
const Rewards = ({ isDarkMode }) => {
  const achievements = [
    ...
    },
    {
      ...
      items: [
        {
          title: 'President - Nova Innovative Compskey (NIC)',
          date: '2024 - Present',
      ...
      items: [
        {
          ...
          date: '2025',
          description: 'Successfully contributed to multiple open-source projects during GSSOC 2025, collaborating with developers worldwide and enhancing coding skills through real-world project experience.',
    ...
    },
    {
      ...
      items: [
        {
          title: 'FinSightAI - Award Winning Project',
          description: 'A platform that demystifies investment decisions by connecting market changes with real-world events, making financial insights accessible to everyday investors.',
          highlight: '2nd Place Winner',
          skills: ['AI', 'Financial Analysis', 'Data Visualization']
        },
        {
          title: 'ZenAI - Medical RAG Chatbot',
          description: 'Built an AI-powered medical chatbot using RAG architecture and Gemini API for accurate, document-grounded medical information.',
          skills: ['RAG', 'LangChain', 'ChromaDB', 'Gemini API']
        },
        {
          title: 'AlgoSphere - ML Projects',
          description: 'Comprehensive machine learning implementations with real-world datasets, featuring complete EDA and model evaluation.',
